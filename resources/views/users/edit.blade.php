        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('user.update', ['id' => $user->user_id]) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="post_name" type="text"
                                           ...
                                           value="{{ old('post_name', $user->post_name) }}" required
                                           autocomplete="post_name" autofocus>
...
{{--                        @csrf--}}
{{--                        @method('DELETE')--}}
{{--                        <button class="btn btn-outline-danger">Delete {{ $user->username }}</button>--}}
{{--                    </form>--}}
{{--                </div>--}}
            </div>
{{--            <div class="col-md-8">--}}
